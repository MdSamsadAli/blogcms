        ...
        <div class="col-lg-5">
            <div class="row px-3">
                <div class="col-12 p-0">
                    <img class="img-fluid w-100" src={{ asset('style/img/about-1.jpg') }} alt="">
                </div>
                <div class="col-6 p-0">
                    <img class="img-fluid w-100" src={{ asset('style/img/about-2.jpg') }} alt="">
                </div>
                <div class="col-6 p-0">
                    <img class="img-fluid w-100" src={{ asset('style/img/about-3.jpg') }} alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row align-items-center">
        <div class="col-lg-5">
            <img class="img-fluid w-100" src={{ asset("style/img/feature.jpg") }} alt="">
        </div>
        <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
    ...
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-lg-4 mb-4">
                <div class="card border-0">
                    <div class="card-header position-relative border-0 p-0 mb-4">
                        <img class="card-img-top" src={{ asset("style/img/price-1.jpg") }} alt="">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0">
                    <div class="card-header position-relative border-0 p-0 mb-4">
                        <img class="card-img-top" src={{ asset("style/img/price-2.jpg") }} alt="">
                        <div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style="top: 0; left: 0; z-index: 1; background: rgba(0, 0, 0, .5);">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0">
                    <div class="card-header position-relative border-0 p-0 mb-4">
                        <img class="card-img-top" src={{ asset("style/img/price-3.jpg") }} alt="">
                        <div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style="top: 0; left: 0; z-index: 1; background: rgba(0, 0, 0, .5);">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <div class="team card position-relative overflow-hidden border-0 mb-4">
                <img class="card-img-top" src={{ asset("style/img/team-1.jpg") }} alt="">
                <div class="card-body text-center p-0">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="team card position-relative overflow-hidden border-0 mb-4">
                <img class="card-img-top" src={{ asset("style/img/team-2.jpg") }} alt="">
                <div class="card-body text-center p-0">
                    <div class="team-text d-flex flex-column justify-content-center bg-light">
                        <h5>Jennifer Page</h5>
                        <i>Chef Executive</i>
    ...
    <div class="row pb-3">
        <div class="col-lg-4 mb-4">
            <div class="card border-0 mb-2">
                <img class="card-img-top" src={{ asset("style/img/blog-1.jpg") }} alt="">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card border-0 mb-2">
                <img class="card-img-top" src={{ asset("style/img/blog-2.jpg") }} alt="">
                <div class="card-body bg-light p-4">
                    <h4 class="card-title text-truncate">Diam amet eos at no eos</h4>
                    <div class="d-flex mb-3">
                        <small class="mr-2"><i class="fa fa-user text-muted"></i> Admin</small>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card border-0 mb-2">
                <img class="card-img-top" src={{ asset("style/img/blog-3.jpg") }} alt="">
                <div class="card-body bg-light p-4">
                    <h4 class="card-title text-truncate">Diam amet eos at no eos</h4>
                    <div class="d-flex mb-3">
                        <small class="mr-2"><i class="fa fa-user text-muted"></i> Admin</small>
